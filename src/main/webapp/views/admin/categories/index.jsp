...
<div class="row">
	<div class="mt-3 d-flex justify-content-end">
		...
		<div class="btn-group" role="group"
			...
			<a href="/HiennvPH13697_Asm/admin/categories/index?field=name"
				type="button" class="btn btn-outline-secondary">Name</a>
		</div>
	</div>
</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Xóa sản danh
									mục phẩm</h5>
								<button type="button" class="btn-close" data-bs-dismiss="modal"
									aria-label="Close"></button>
							</div>
							<div class="modal-body">Bạn chắc chắn muốn danh mục xóa sản
								phẩm này hay không ?</div>
